...
SHA2_TEMPLATE
class Sha2_ctx<std::uint32_t>;
SHA2_TEMPLATE
class Sha2_ctx<std::uint64_t>;
SHA2_TEMPLATE
class Sha2<std::uint32_t, 224, sha2::h0_224>;
SHA2_TEMPLATE
class Sha2<std::uint32_t, 256, sha2::h0_256>;
SHA2_TEMPLATE
class Sha2<std::uint64_t, 384, sha2::h0_384>;
SHA2_TEMPLATE
class Sha2<std::uint64_t, 512, sha2::h0_512>;
SHA2_TEMPLATE
class Sha2<std::uint64_t, 224, sha2::h0_512_224>;
SHA2_TEMPLATE
class Sha2<std::uint64_t, 256, sha2::h0_512_256>;
#undef SHA2_TEMPLATE
